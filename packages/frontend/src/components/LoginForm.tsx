 ...
 * ログインフォームコンポーネント
 * 
 * モダンデザインによるFirebase認証ログイン機能。
 * Tailwind CSSによるスタイリング、アニメーション、
 * アクセシビリティ対応を含む。
 */
...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div data-testid="login-page" className="min-h-screen bg-gradient-hero flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="card-soft p-8 animate-fade-in">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className="w-8 h-8 bg-gradient-to-r from-primary-500 to-success-500 rounded-xl flex items-center justify-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary w-full py-3 text-base relative overflow-hidden group transform hover:scale-[1.02] transition-all duration-200"
            >
